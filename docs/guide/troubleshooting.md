...
- Availability and reachability of local port `18601`.
...
5. **Port conflict or Firewall**: The bridge binds to local port `18601` by default. Ensure no other application is using this port and your firewall allows localhost WebSocket connections.
